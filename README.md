...
- Full end-to-end message-type test reports live in
  `app/docs/Bifrost_Hnitbjorg_MessageType_TestReport_<date>.md`, generated by
  `tools/make_report.py` from JSON-line scenario logs; the open defect list, if any, is in that
  report's "Defects and observations" section.
